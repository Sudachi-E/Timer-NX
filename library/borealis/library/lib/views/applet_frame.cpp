...
const std::string appletFrameXML = R"xml(
    <brls:Box
        ...
        <brls:Box
            ...
            <brls:Box
                id="brls/applet_frame/right_container"
                width="auto"
                height="auto"
                axis="row"
                alignItems="center">
                <brls:Box
                    ...
                    axis="row"/>
                <brls:Battery
                    id="brls/applet_frame/header_battery"
                    width="44"
                    height="44"/>
            </brls:Box>
...
AppletFrame::AppletFrame()
{
    ...
    View* bottomBattery = footer->getView("brls/battery");
    if (bottomBattery)
        bottomBattery->setVisibility(Visibility::GONE);
    View* bottomWireless = footer->getView("brls/wireless");
    if (bottomWireless)
        bottomWireless->setVisibility(Visibility::GONE);
}
